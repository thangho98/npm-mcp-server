...
// ============ PROXY HOSTS ============
server.tool("list_proxy_hosts", "List all proxy hosts configured in Nginx Proxy Manager", {}, async () => {
    try {
...
server.tool("get_proxy_host", "Get details of a specific proxy host by ID", {
...
server.tool("create_proxy_host", "Create a new proxy host to forward traffic from domain(s) to a backend server", {
    domain_names: z
        .array(z.string())
...
server.tool("update_proxy_host", "Update an existing proxy host", {
...
server.tool("delete_proxy_host", "Delete a proxy host", {
...
server.tool("enable_proxy_host", "Enable a proxy host", {
...
server.tool("disable_proxy_host", "Disable a proxy host", {
...
// ============ STREAMS ============
server.tool("list_streams", "List all TCP/UDP stream configurations", {}, async () => {
    try {
...
server.tool("create_stream", "Create a new TCP/UDP stream to forward traffic on a specific port", {
...
server.tool("delete_stream", "Delete a stream", {
...
server.tool("enable_stream", "Enable a stream", {
...
server.tool("disable_stream", "Disable a stream", {
...
// ============ REDIRECTION HOSTS ============
server.tool("list_redirection_hosts", "List all redirection hosts", {}, async () => {
    try {
...
server.tool("create_redirection_host", "Create a new redirection host to redirect traffic from domain(s) to another URL", {
...
server.tool("delete_redirection_host", "Delete a redirection host", {
...
// ============ CERTIFICATES ============
server.tool("list_certificates", "List all SSL certificates", {}, async () => {
    try {
...
server.tool("get_certificate", "Get details of a specific certificate", {
...
server.tool("renew_certificate", "Renew an SSL certificate", {
...
server.tool("delete_certificate", "Delete an SSL certificate", {
...
// ============ ACCESS LISTS ============
server.tool("list_access_lists", "List all access lists", {}, async () => {
    try {
...
server.tool("create_access_list", "Create a new access list for authentication or IP-based access control", {
...
server.tool("delete_access_list", "Delete an access list", {
...
// ============ DEAD HOSTS (404) ============
server.tool("list_dead_hosts", "List all 404 hosts (domains that show a 404 page)", {}, async () => {
    try {
...
server.tool("create_dead_host", "Create a new 404 host (shows 404 page for specified domains)", {
    domain_names: z.array(z.string()).describe("List of domain names"),
    certificate_id: z.number().optional().describe("SSL certificate ID"),
    ssl_forced: z.boolean().default(false).describe("Force SSL"),
}, async (params) => {
...
server.tool("delete_dead_host", "Delete a 404 host", {
...
// ============ USERS ============
server.tool("list_users", "List all users in Nginx Proxy Manager", {}, async () => {
    try {
...
// ============ HEALTH ============
server.tool("get_status", "Get the health status, version, and mode of Nginx Proxy Manager MCP server", {}, async () => {
    try {
